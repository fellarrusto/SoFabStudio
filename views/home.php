    ...
    <section class="position-relative py-4 py-xl-5">
        ...
        <footer class="text-center">
            <div class="container text-muted py-4 py-lg-3" style="color: var(--bs-emphasis-color);margin-top: 30px;">
                ...
                <p class="mb-0" style="font-family: 'Space Grotesk', sans-serif;"><span style="color: rgb(0, 0, 0);">Fabrizio Somma - So Fab Studio |</span> <a href="mailto:info@sofabstudio.com" style="text-decoration:none;"><span style="color: rgb(0, 0, 0);">info@sofabstudio.com</span></a>&nbsp;|&nbsp;<a href="tel:00393792419000" style="text-decoration:none;"><span style="color: rgb(0, 0, 0);">+39 3792419000</span></a></p>
